...
<center>
    ...
    <h2>Ajouter un nouveau étudiant</h2>
        ...
        <form class="form-detail" method="post" action="http://localhost/LoginMVC/MVC/index.php?action=cAddStudent" enctype="multipart/form-data">    
            <div class="form-row">
        ...
        <center><a href="http://localhost/LoginMVC/MVC/index.php"> <button>Retour</button></a></center>
        <br>
        <br>
    </div>
</center>
